...
class LocationCreate(LocationBase):
    organizationId: uuid.UUID # Must be provided during creation
...
class LocationInDBBase(LocationBase):
    id: uuid.UUID
    organizationId: uuid.UUID # Ensure this is part of the DB model representation
    createdAt: datetime
    updatedAt: datetime
...
class LocationSchema(LocationInDBBase):
    pass
